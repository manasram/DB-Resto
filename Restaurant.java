...
System.out.println("----------- Connection to Oracle on Omega ----------");
try {
...
System.out.println("\nPlease PLEASE ONE OF THE FOLLOWING OPTIONS : ");
System.out.println("\n\n1.EMPLOYEE LOGIN");
System.out.println("\n\n2.CUSTOMER LOGIN");
...
try{
stmt=connection.createStatement();
ResultSet rs=stmt.executeQuery("select e.FName,e.LName from F15_10_Employee e,F15_10_Leave l where e.EmpID=l.EmpID and ((l.ToDate-l.FromDate)>10) order by e.FName");
while(rs.next())
{
